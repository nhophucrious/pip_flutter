...
abstract class VideoPlayerPlatform {
  ...
  Future<int?> create({PipFlutterPlayerBufferingConfiguration? bufferingConfiguration}) {
  ...
  /// Sets the set Automatic PIP of the video.
  Future<void> setAutomaticPIP(bool isAuto, int? textureId) {
    throw UnimplementedError('setAutomaticPIP() has not been implemented.');
  }
