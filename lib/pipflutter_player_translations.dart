///Class used to hold translations for all features within PipFlutter Player
class PipFlutterPlayerTranslations {
  ...
  factory PipFlutterPlayerTranslations.polish() => PipFlutterPlayerTranslations(
        languageCode: "pl",
  ...
  factory PipFlutterPlayerTranslations.hindi() => PipFlutterPlayerTranslations(
        languageCode: "hi",
  ...
  factory PipFlutterPlayerTranslations.arabic() => PipFlutterPlayerTranslations(
        languageCode: "ar",
